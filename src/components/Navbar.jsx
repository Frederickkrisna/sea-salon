          ...
          <div className="container px-4 mx-auto relative text-sm">
              <div className="flex justify-between items-center ">
                ...
                <div className="flex items-center flex-shrink-0 w-[15vh] justify-end">
                    <div className="hover:cursor-pointer tracking-tight border-[0.4vh] px-3 py-2 rounded-md border-black text-black" onClick={() => handleClick("/login")}>Login</div>
                </div>
                ) :
                (
                    <div className="flex items-center flex-shrink-0 w-[15vh] justify-end">
                    <div className="hover:cursor-pointer tracking-tight border-[0.4vh] px-3 py-2 rounded-md  border-red-600 text-red-600" onClick={() => signOut()}>Logout</div>
                </div>
                )}
